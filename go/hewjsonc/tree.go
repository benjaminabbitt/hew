// Package hewjsonc is hew's JSONC format binding (§8.2): everything §8.1's
// JSON binding does, plus comments as first-class, addressable nodes.
//
// It is a deliberate FORK of hewjson rather than an extension of it. Three
...
//
// Extending hewjson in place would have meant either exporting most of its
...
// hewjson keeps rejecting comment ops with HEW020 (json/comment-inexpressible)
