...
// (§8.3) and HCL (§8.5) appliers are bound, as are Resolve (§9.2) and
// --ops/--record (§9.7). Remaining: the TOML applier, the differ (P4), and
...
var skipRules = []harness.SkipRule{
	...
	// TOML parses and renders for real (§8.4 table headers and dotted keys);
	// what it has yet is an applier, a differ, or a CLI backend.
