...
// applyByFormat dispatches to the one format binding this slice ships
// (§8.1's JSON) and fails loud (HEW021) for anything else, matching the
// spec's own registration model (Appendix A.6) without the registry
// indirection a single binding doesn't need yet.
