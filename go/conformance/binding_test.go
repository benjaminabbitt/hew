...
// JSON, §8.2's JSONC, §8.3's YAML, §8.4's TOML) and fails loud (HEW021) for
// anything else, matching the spec's own registration model (Appendix A.6)
// without the registry indirection a handful of bindings doesn't need yet.
