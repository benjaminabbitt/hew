...
func TestSegmentArgConstructors(t *testing.T) {
	for _, tc := range []struct {
		...
		{"label", Label("google"), Segment{Kind: SegLabel, Name: "google"}},
		{"quoted", Quoted("google"), Segment{Kind: SegLabel, Name: "google"}},
...
func TestHoleArgumentSurvivesRendering(t *testing.T) {
	t.Skip("pending p5/quoted-keys merge: canonical rendering's bijection (O41)")
